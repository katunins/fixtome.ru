...
<div class="container">
    ...
    <div class="main-block main-block-neworder">
        ...
        <div class="utp">
            <p>
                Опрос "{{ $data['title'] }}" создан и доступен по <a href="{{ URL('/') }}/research/{{ $data['token'] }}"
                    target="blank">ссылке</a>
                .Отправьте ссылку своим пользователям.
            </p>
    ...
    <div class="info-block hide">
        ...
        <h3>Павел Катунин</h3>
        <p>Fullstack разработка продающих сервисов и конструкторов. Создание контента</p>
